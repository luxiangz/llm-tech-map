...
<h2 id="一深度学习与机器学习基础">一、深度学习与机器学习基础</h2>
...
<h2 id="二transformer-与模型架构">二、Transformer 与模型架构</h2>
...
<h2 id="四后训练对齐与微调">四、后训练：对齐与微调</h2>
...
<h2 id="五推理引擎与-serving">五、推理引擎与 Serving</h2>

### 5.1 推理机制
- [ ] 自回归解码与 KV Cache
- [ ] PagedAttention、连续批处理（Continuous Batching）
- [ ] 分块预填充（Chunked Prefill）、PD 分离
...
<h2 id="七ai-硬件与集群基础设施">七、AI 硬件与集群基础设施</h2>
...
<h2 id="八agent-与应用层">八、Agent 与应用层</h2>
